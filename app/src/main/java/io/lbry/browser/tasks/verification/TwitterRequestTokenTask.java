...
public class TwitterRequestTokenTask extends AsyncTask<Void, Void, String> {
    ...
    public TwitterRequestTokenTask(TwitterOauthHandler handler) {
    ...
    public String doInBackground(Void... params) {
        try {
            ...
            signer.clientSharedSecret = new String(
                    Base64.decode(VerificationActivity.CONSUMER_SECRET, Base64.NO_WRAP), StandardCharsets.UTF_8.name());

            OAuthParameters oauthParams = new OAuthParameters();
            oauthParams.callback = "https://lbry.tv";
            oauthParams.consumerKey = new String(
                    Base64.decode(VerificationActivity.CONSUMER_KEY, Base64.NO_WRAP), StandardCharsets.UTF_8.name());;
